...
function _update()
    ...
    if diver_y >= 128 - diver_size then
        if check_box_collision(flr(diver_x) + 6, flr(diver_y), 4, 16,
...
function _draw()
    ...
    if current_state == game_state.splash then
        print_centered("skydiver!", 30, 0)
        print_centered("n: new game", 50, 0)
        print_centered("move left and right", 70, 0)
        print_centered("to hit the target!", 80, 0)
        print_centered("avoid the crows!", 100, 0)
        print_centered("up slows and down hastens dive!", 120, 0)
        return
    else
...
__gfx__

